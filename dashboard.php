...
///// SQL QUERY
		...
		$mastercount = mysql_query("SELECT COUNT(DISTINCT tincidents.id) $from"); 
		...
		if ($rparameters['debug']==1)
		{
			...
			<br />
	    	SELECT COUNT(DISTINCT tincidents.id)<br />
			$from
			";
		}
			...
			<table id="sample-table-1" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr >
						...
						<th <?php if ($_GET['order']=='date_create') echo 'class="active"'; ?> >
							<center>
								<a title="Date de création la demande"  href="<?php echo $url; ?>&amp;order=date_create&amp;way=<?php echo $arrow_way; ?>">
