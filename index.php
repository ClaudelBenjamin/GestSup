...
if ($_SESSION['user_id'])
{
	...
	//load user table
	$quser = mysql_query("SELECT skin FROM `tusers` WHERE id=$_SESSION[user_id]"); 
...
<html lang="fr">
	...
	<?php
		...
		if ($_SESSION['user_id'])
		{
			...
			//user bar queries 
			$cnt3 = mysql_query("SELECT count(*) FROM `tincidents` WHERE $profile='$_SESSION[user_id]' and techread='0' and disable='0'"); 
					...
					<div class="navbar-container" id="navbar-container">
						<div class="navbar-header pull-left">
							<a href="#" class="navbar-brand">
								...
								GestSup
								<font size="1px">'.$rparameters['version'].'</font>
							...
							<ul class="nav ace-nav">';
								...
								<li class="light-blue">
									...
									<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
										<li>
											<a href="./index.php?page=admin/user&amp;action=edit&amp;id='.$_SESSION['user_id'].'">
												<i class="icon-user"></i>
												Profil
											</a>
										</li>
					...
					<div class="main-container-inner">
						...
						<div class="main-content">
							<div class="breadcrumbs" id="breadcrumbs">
								...
								<ul class="breadcrumb">
									<li>
										...
										if($_GET['page']=='admin/user' && $_GET['action']=='edit') echo ' <a href="index.php?page=admin/user&action=edit&id='.$_GET['id'].'">Fiche utilisateur</a>';
							...
							<div class="page-content">
								';
								//security check
								if(($_SESSION['profile_id']!=4 && $_SESSION['profile_id']!=0) && ($_SESSION['user_id']!=$_GET['userid'])) {
								    echo '<div class="alert alert-danger"><strong><i class="icon-remove"></i>Erreur:</strong> Vous n\'avez pas les droits de visualiser les tickets d\'un autre utilisateur, contacter votre administrateur.<br></div>';
								} else 
								{
