				...
				if ($rright['ticket_thread_add']!=0)
				{
					...
					<table border="0"  width="700" >
						<tr>
							...
							<td>	
								&nbsp;&nbsp;<button class="btn btn-sm btn-success" title="'.$button.'" name="modify" value="modify" type="submit" id="modify">'.$button.' <i class="icon-arrow-right icon-on-right"></i></i></button>
							</td>
						</tr>
					</table>
					';
